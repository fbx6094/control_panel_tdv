...
app.get('/', (req, res) => {
  ...
  <body>
      ...
      <h1 style="text-align: center; color: red;">ПАНЕЛЬ УПРАВЛЕНИЯ ОЧКОВ ВТОРОЙ КОМАНДЫ(ПРАВОЙ)</h1>
      <button id="button" onclick="updateScore('element_on_street_1_team_2')">Элемент установлен на улице Медиа для второй команды</button>
      <br>
      <br>
      <button id="button" onclick="updateScore('element_on_street_2_team_2')">Элемент установлен на улице Первых для второй команды</button>
      <br>
      <br>
      <button id="button" onclick="updateScore('element_on_street_3_team_2')">Элемент установлен на улице Истории для второй команды</button>
      <br>
      <br>
      ...
      <br>
      <br>
      <button id="button" onclick="updateScore('parking_on_warehouse_team_2')">Парковка на складе первая команда</button>
      <br>
      <br>
      <button id="button" onclick="updateScore('parking_anywhere_team_2')">Парковка на любой из улиц первая команда</button>
      <br>
      <br>
      ...
      <br>
      <br>
      <button id="button" onclick="updateScore('opponents_house_broken_by_team_2')">Поломка дома соперника первая
          команда</button>
      <br>
      <br>
      <button id="button" onclick="updateScore('skyscraper_broken_by_team_2')">Поломка небоскреба первая команда</button>
      <br>
      <br>
      <button id="button" onclick="updateScore('opponents_robot_broken_team_2')">Поломка робота соперника первая
          команда</button>
      <br>
      <br>
      <button id="button" onclick="updateScore('opponents_triangle_taken_by_team_2')">Захват конуса соперника первая
          команда</button>
      <br>
      <br>
...
app.get('/update-score', (req, res) => {
    ...
    //ПЕРВАЯ КОМАНДА
    else if (action === 'element_on_street_1_team_2') {
        updateValue = 2 + counter1;
        // team = 1;
        msg = 'element_on_street_1_team_2';
        counter1 += 1;
        team2 = 1;
        console.log(counter1)
    } else if (action === 'element_on_street_2_team_2') {
        updateValue = 2 + counter2;
        // team = 1;
        msg = 'element_on_street_2_team_2';
        counter2 += 1;
        team2 = 2;
        console.log(counter2)
    } else if (action === 'element_on_street_3_team_2') {
        updateValue = 2 + counter3;
        // team = 1;
        msg = 'element_on_street_3_team_2';
        counter3 += 1;
        team2 = 3;
    ...
    if (skyscraper === 1) {
        ...
        pool.query('UPDATE score SET score_team_2 = score_team_2 + $1, team_2_score_street_1 = team_2_score_street_1 + 1', [updateValue], (error, results) => {
          if (error) {
            res.status(500).json({ success: false, message: 'Ошибка обновления счёта' });
            console.log("success: false, message: Ошибка обновления счёта  ", msg);
            console.log(counter);
        ...
        pool.query('UPDATE score SET score_team_2 = score_team_2 + $1, team_2_score_street_2 = team_2_score_street_2 + 1', [updateValue], (error, results) => {
          if (error) {
            res.status(500).json({ success: false, message: 'Ошибка обновления счёта' });
            console.log("success: false, message: Ошибка обновления счёта  ", msg);
            console.log(counter2);
        ...
        pool.query('UPDATE score SET score_team_2 = score_team_2 + $1, team_2_score_street_3 = team_2_score_street_3 + 1', [updateValue], (error, results) => {
          if (error) {
            res.status(500).json({ success: false, message: 'Ошибка обновления счёта' });
            console.log("success: false, message: Ошибка обновления счёта  ", msg);
            console.log(counter3);
